...
$route['tips-and-prediction'] = 'Home_controller/tips_and_prediction'; 
$route['profile-edit'] = 'Home_controller/profileEdit'; 
$route['profile-update/(:any)'] = 'Home_controller/profile_update/$1';  
$route['sign-in'] = 'Home_controller/sign_in';
$route['sign-in-complete'] = 'Home_controller/signInComplete';
$route['sign-up'] = 'Home_controller/signUp';
$route['sign-up-complete'] = 'Home_controller/signUpComplete';
$route['user-logout'] = 'Home_controller/logout';
$route['news-details/(:any)/(:any)'] = 'Home_controller/newsDetails/$1/$2';
$route['cricket'] = 'Home_controller/cricket';
$route['football'] = 'Home_controller/football';
