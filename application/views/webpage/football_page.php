 ...
 <!-- Advertisement -->
          ...
          <div class="grid lg:grid-cols-3 gap-5 xl:gap-8">
            <div class="lg:col-span-2">
              <div>
                <div class="news-card-big bg-transparent relative">
                  <div class="rounded-xl">
                    <img
                      src="<?php echo base_url()?>uploads/<?php echo $latest_football_news[0]->image;?>"
                      alt="poster"
                  ...
                  <div class="px-4 lg:px-10 absolute bottom-5 z-50 w-full">
                    <h4 class="mb-3 text-lg lg:text-2xl font-semibold text-white ellipsis-text text-black">
                      <a href="<?php echo base_url('news-details/').'football'.'/'.$latest_football_news[0]->encode_title;?>"><?php echo $latest_football_news[0]->stitle;?></a>
                    </h4>
                    <div class="flex justify-between items-center">
                      <p class="news-tag">News</p>
                      <a onclick="shareContent('<?php echo $latest_football_news->encode_title ?>','<?php echo $latest_football_news->encode_title ?>','<?php echo base_url('news-details/').'football'.'/'.$latest_football_news->encode_title;?>')">
              ...
              <div class="mt-5 lg:mt-8 grid lg:grid-cols-2 gap-3 lg:gap-5">
                <?php foreach($latest_football_news as $key=>$latest_football_data){?>
                    <?php 
                          if($key==0){
                            continue;
                          }
                        ...
                        $difference = time() - $latest_football_data->time_stamp;
                  ...
                  <div class="small-img">
                    <img
                      src="<?php echo base_url()?>uploads/<?php echo $latest_football_data->image;?>"
                      alt="poster"
                    />
                  </div>
                  <div class="news-card-small-content px-3 py-4">
                    <h4 class="news-small-heading ellipsis-text text-black">
                      <a href="<?php echo base_url('news-details/').'football'.'/'.$latest_football_data->encode_title;?>"><?php echo $latest_football_data->stitle;?></a>
                    </h4>
                    <div>
                      <p class="text-black">                        
                        <?php echo $time;?>
            ...
            <div class="bg-transparent rounded-xl px-4 py-6">
              <h2 class="mb-8 text-xl lg:text-3xl font-semibold">Latest news</h2>
              <div class="space-y-5">
               <?php foreach($latest_football_news as $key=>$latest_football_data){?>
                <?php 
                    $difference = time() - $latest_football_data->time_stamp;
                    ...
                    $time .= "ago";
                  ?>    
                 <div class="news-card-small bg-transparent border-[#D9D9D9] !items-center !px-0 !py-0 md:!min-h-fit xl:!min-h-fit">
                 
                  <div class="shrink-0 w-10 xl:w-[50px] h-10 xl:h-[50px] bg-white rounded-full grid place-content-center text-base text-black xl:text-2xl font-semibold">
                    <?php echo $key+1;?>
                  </div>
                  <div class="news-card-small-content">
                    <h4 class="news-small-heading ellipsis-text text-black">
                      <a href="<?php echo base_url('news-details/').'football'.'/'.$latest_football_data->encode_title;?>"><?php echo $latest_football_data->title?></a>
                    </h4>
                    <div>
      ...
      <section class="section-padding">
        <div class="custom-container">
          <div class="grid lg:grid-cols-3 gap-5 xl:gap-7">
            <div class="lg:col-span-2">
              <h2 class="mb-8 text-black text-xl lg:text-2xl 2xl:text-3xl font-semibold">Football Videos</h2>
              <div class="grid lg:grid-cols-3 gap-4 lg:gap-5">
                <div class="video-modal">
                  <div id="video-modal-open0" class="h-[305px] relative">
                    <iframe class="h-full" width="100%" src="https://www.youtube.com/embed/zqxV0ken2jg?si=ON4gFKEGLCWM8oKz" 
                  ...
                  <dialog class="w-full lg:w-1/2 relative bg-transparent">
                    ...
                    <div>
                      <iframe class="modal-video" width="100%" src="https://www.youtube.com/embed/zqxV0ken2jg?si=ON4gFKEGLCWM8oKz" 
      ...
      <!--          <?php foreach($latest_football_videos as $key => $latest_football_video){?>-->
      <!--             <div class="video-modal">-->
      <!--            <div id="video-modal-open<?php echo $key;?>" class="h-[305px] relative">-->
      <!--              <iframe class="h-full" width="100%" src="<?php echo $latest_football_video->videos;?>" -->
      <!--                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; web-share" -->
      <!--                allowfullscreen>-->
      <!--              </iframe>-->
      <!--              <div class="absolute inset-0 w-full h-full z-50 bg-transparent cursor-pointer"></div>-->
      <!--            </div>-->
      <!--            <h5 class="mt-3 text-base xl:text-lg font-medium text-black"><?php echo $latest_football_video->title;?></h5>-->
      <!--            <dialog class="w-full lg:w-1/2 relative bg-transparent">-->
      <!--              <div class="flex justify-end">-->
      <!--                <button autofocus class="mb-5 outline-none bg-white w-8 h-8 rounded-full text-danger text-lg font-semibold text-center">-->
      <!--                  <i class="fa-solid fa-xmark"></i>-->
      ...
      <!--              </div>-->
      <!--              <div>-->
      <!--                <iframe class="modal-video" width="100%" src="<?php echo $latest_football_video->videos;?>" -->
      <!--                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" -->
      <!--                  allowfullscreen>-->
      <!--                </iframe>-->
      <!--              </div>-->
...
<script>
  $(document).ready(function(){ 
    ...
    function cricketApi(value = "football",api_key="afaac2bb003f9d1496139436d4c337cf230d6cf894915206e342e148f7df084f"){
        //console.log(value);
