              ...
              <div class="custom-container">
                <div class="mb-5 flex justify-between items-center">
                  ...
                  <select
                    name="games"
                    id="games"
                    class="py-3 px-6 rounded-lg bg-transparent border border-[#D8DCE3] text-xs lg:text-base font-semibold outline-none"
                  >
              ...
              <div class="lg:w-[55%]">
                <div class="news-card-big bg-transparent  border-[#D9D9D9] ">
                  <div class="big-img mobile-big-img">
                    <img
                      src="<?php echo base_url()?>uploads/<?php echo $latest_random_news[0]->image;?>"
                      alt="poster"
                  ...
                  <div class="px-3 py-4">
                    ...
                    <div class="flex justify-between items-center">
                      ...
                      <a onclick="shareContent('<?php echo $latest_random_news[0]->stitle?>','<?php echo $latest_random_news[0]->stitle?>','<?php echo base_url('news-details/').'featured-cricket'.'/'.$latest_random_news[0]->encode_title;?>')">
                           <img src="<?php echo base_url();?>/src/images/global/share.png"
                            alt="share icon"
                          />
                       </a>
                    </div>
              ...
              <div class="lg:w-[45%] space-y-4 md:space-y-0 lg:space-y-4 md:grid lg:block md:grid-cols-2  lg:grid-cols-1 md:gap-4 lg:gap-0">
               <?php foreach($latest_random_news as $key=>$latest_random_new){?>
                ...
                <div class="news-card-small bg-transparent   border-[#D9D9D9] border-2">
                  <div class="small-img">
                    <img
                      src="<?php echo base_url()?>uploads/<?php echo $latest_random_new->image;?>"
                      alt="poster"
                    />
                  </div>
              ...
              <div class="grid md:grid-cols-2 gap-4 xl:gap-6">
                ...
                <?php 
                  ...
                  <div class="news-card-small bg-transparent  border-[#D9D9D9] border-2 ">
                    <div class="small-img">
                      <img
                        src="<?php echo base_url()?>uploads/<?php echo $latest_crickets_new->image;?>"
                        alt="poster"
                      />
                    </div>
                    <div class="news-card-small-content">
                ...
                <?php 
                  ...
                  <div class="news-card-small bg-transparent border-[#D9D9D9] border-2">
                    <div class="small-img">
                      <img
                        src="<?php echo base_url()?>uploads/<?php echo $latest_cricket->image;?>"
                        alt="poster"
                      />
                    </div>
                    <div class="news-card-small-content">
            ...
            <div class="lg:w-[66%] space-y-4">
             ...
             <?php 
                  ...
                  <div class="news-card-small bg-transparent border-[#D9D9D9] border-2 ">
                    <div class="small-img">
                      <img
                        src="<?php echo base_url()?>uploads/<?php echo $latest_football_new->image;?>"
                        alt="poster"
                      />
                    </div>
                    <div class="news-card-small-content ">
                ...
                foreach($latest_footballs as $key=>$latest_football){?>
                  <div class="news-card-small bg-transparent border-[#D9D9D9]">
                    <div class="small-img">
                      <img
                        src="<?php echo base_url()?>uploads/<?php echo $latest_football->image;?>"
                        alt="poster"
                      />
                    </div>
                    <div class="news-card-small-content">
            ...
            <div class="lg:w-[66%]">
              <div class="news-card-big bg-transparent border-[#D9D9D9] border-2 ">
                <div class="h-[505px] xl:h-[600px]">
                  <img
                    src="<?php echo base_url()?>uploads/<?php echo $premier_league_news[0]->image;?>"
                    alt="poster"
            ...
            <div class="lg:w-[33%] space-y-4 md:space-y-0 lg:space-y-4 md:grid lg:block md:grid-cols-2 lg:grid-cols-1 md:gap-4 lg:gap-0">
              <?php foreach($premier_league_news as $key=>$premier_league_new){?>
                ...
                <div class="news-card-small  bg-transparent border-[#D9D9D9] border-2">
                  <div class="small-img">
                    <img
                      src="<?php echo base_url()?>uploads/<?php echo $premier_league_new->image;?>"
                      alt="poster"
                    />
                  </div>
        ...
        <div class="custom-container">
          ...
          <?php foreach($kabadi_news as $key=>$kabadi_news_data){?> 
            <div class="news-card-big bg-transparent  border-[#D9D9D9]">
              <div class="big-img mobile-big-img">
                <img
                  src="<?php echo base_url()?>uploads/<?php echo $kabadi_news_data->image;?>"
                  alt="poster"
                  class="h-full w-full rounded-t-xl"
                />
              </div>
  ...
  $(document).ready(function(){ 
    ...
    function cricketApi(value = "cricket",api_key="afaac2bb003f9d1496139436d4c337cf230d6cf894915206e342e148f7df084f"){
        ...
        fetch(apiUrl)
            ...
            .catch(error => {
                   html = `<div class="min-w-[276px] lg:min-w-[350px] py-3 lg:py-5 px-4 lg:px-6  rounded-xl">
              <div class="flex justify-between items-start gap-2">
                <div>
